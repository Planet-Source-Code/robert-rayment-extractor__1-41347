...
Public Sub ModReDim(frm As Form)
...
'-----------------------------------------------
'Special
If picHt > frm.Picture1.Height Then frm.fraScr(0).Visible = True
If picWd > frm.Picture1.Width Then frm.fraScr(1).Visible = True
...
Public Sub LabThumbMouseDown(frm As Form, Index As Integer, X As Single, Y As Single)
...
Public Sub LabThumbMouseMove(frm As Form, Index As Integer, _
...
Public Sub LabThumbMouseUp(frm As Form, Index As Integer, _
X As Single, Y As Single)
...
Public Sub LabBackMouseDown(frm As Form, Index As Integer, _
X As Single, Y As Single)
...
Public Sub LabBackMouseUp(frm As Form)
...
Public Sub cmdScrMouseDown(frm As Form, Index As Integer, Button As Integer, _
X As Single, Y As Single)
...
Public Sub cmdScrMouseUp(frm As Form)

frm.Timer1.Enabled = False
frm.cmdShiftFocus.Visible = True
frm.cmdShiftFocus.SetFocus
frm.cmdShiftFocus.Visible = False
...
Public Sub Timer1Timer(frm As Form)
